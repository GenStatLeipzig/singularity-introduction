...
# Instead of downloading, the image can be build using the local singularity instance according t
```
...
[definition file](https://docs.sylabs.io/guides/3.10/user-guide/definition_files.html#definition-files)
