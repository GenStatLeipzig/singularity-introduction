...
* Using `ReadTheDocs`, based on `Sphinx`
* Reicht Sphinx? (+  sphinx_rtd_template) --> RTD for hosting!
* Myst statt RST nutzen? --> Vorteil einfaches MD
* MKDocs statt Sphinx nutzen? --> Vorteil ???
* Statt MD nutzt Sphinx reStructuredText markup language
...
ssh cw897rwyu@galaxy101.sc.uni-leipzig.de
