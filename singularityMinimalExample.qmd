...
*   files in image: analysis script
*   mounted directory: results and input files (--> minimize mounts in filesystem)
*   copied files: analysis scripts & maybe persistent inputs? 
*   Running script via `Rscript --vanilla --verbose` https://stackoverflow.com/questions/14167178/passing-command-line-arguments-to-r-cmd-batch
